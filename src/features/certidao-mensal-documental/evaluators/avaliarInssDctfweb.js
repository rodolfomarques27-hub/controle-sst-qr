...
function extrairCompetenciaDocumento(
    ...
    const padroes = [
        /PERIODO\s+DE\s+APURACAO\s*[:|\-]?\s*\/?\s*(0?[1-9]|1[0-2])\s*[/.:-]\s*(20\d{2})/,
        /PERIODO\s+APURACAO\s*[:|\-]?\s*\/?\s*(0?[1-9]|1[0-2])\s*[/.:-]\s*(20\d{2})/,
        /COMPETENCIA\s*[:|\-]?\s*\/?\s*(0?[1-9]|1[0-2])\s*[/.:-]\s*(20\d{2})/,
        /MES\s+DE\s+REFERENCIA\s*[:|\-]?\s*\/?\s*(0?[1-9]|1[0-2])\s*[/.:-]\s*(20\d{2})/,
        /REFERENCIA\s*[:|\-]?\s*\/?\s*(0?[1-9]|1[0-2])\s*[/.:-]\s*(20\d{2})/,
        /\bPA\s*[:|\-]?\s*\/?\s*(0?[1-9]|1[0-2])\s*[/.:-]\s*(20\d{2})/,
    ];
