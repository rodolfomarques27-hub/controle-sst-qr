...
export function CertidaoUploadMassaJobProvider({
    ...
    // ============================================================
    // SAFE_SCAN_CERTIDAO_R9_WRITE_UNICO_V1
    //
    // Autorização temporária para o PRIMEIRO write real.
    //
    // Máximo absoluto:
    // 1 chamada à Persistence durante a vida deste Provider.
    //
    // A trava é consumida ANTES da chamada remota e não é resetada
    // em sucesso, falha confirmada ou ambiguidade.
    // ============================================================

    const r9PersistenciaUnicaRef =
        useRef(
            false
        );
    ...
    const executorPersistenciaPrincipal =
        useCallback(
            async ({
                ...
                if (
                    r9PersistenciaUnicaRef
                        .current ===
                    true
                ) {
                    const erro =
                        new Error(
                            "R9: segunda tentativa de persistência bloqueada localmente."
                        );
                ...
                /*
                 * Consumir ANTES do primeiro request remoto.
                 *
    ...
    const uploadMassa =
        useCertidaoMensalUploadMassa({
             ...
             * SAFE_SCAN_CERTIDAO_R9_GATE_UNITARIO_V1
             *
