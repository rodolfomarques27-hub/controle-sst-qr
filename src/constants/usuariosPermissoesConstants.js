...
export const MODULOS_USUARIOS_PERMISSOES = [
    ...
    { chave: "vistoria_visualizar", modulo: "Vistoria - Visualizar" },
    { chave: "vistoria_editar", modulo: "Vistoria - Editar" },
];
...
export const PERMISSOES_PADRAO_USUARIOS_POR_PERFIL = [
    ...
    },
    {
        ...
        modulosLiberados: ["Dashboard Auditoria", "Nova Auditoria", "QR Code", "Relatórios", "Vistoria - Visualizar"],
    ...
    },
    {
        ...
        modulosLiberados: ["Dashboard SST", "Dashboard Auditoria", "Empresas", "Colaboradores", "Treinamentos", "QR Code", "Relatórios", "Vistoria - Visualizar"],
    ...
    },
    {
        ...
        modulosLiberados: ["Dashboard SST", "Empresas", "Colaboradores", "Treinamentos", "QR Code", "Relatórios", "Vistoria - Visualizar"],
