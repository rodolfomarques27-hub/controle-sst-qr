...
export const UPLOAD_MENSAGEM_PDF_GRANDE =
    "O arquivo PDF está muito grande. Para reduzir o uso de armazenamento, compacte o PDF antes de enviar. Recomendamos escanear documentos em 150 ou 200 DPI, em preto e branco ou tons de cinza quando possível.";
export const UPLOAD_MENSAGEM_IMAGEM_OTIMIZAVEL =
    "Imagem acima do recomendado. O sistema tentará reduzir automaticamente antes do envio, mantendo qualidade suficiente para consulta.";
