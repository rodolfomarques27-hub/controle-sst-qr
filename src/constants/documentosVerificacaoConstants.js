...
export const DOCUMENTOS_VERIFICACAO_PESOS = Object.freeze({
    ...
    NENHUMA_DATA_LOCALIZADA_DOCUMENTO: 10,
    DATA_CADASTRO_NAO_LOCALIZADA_DOCUMENTO_LEVE: 20,
    DATA_CADASTRO_NAO_LOCALIZADA_DOCUMENTO: 45,
    DATA_VENCIMENTO_DIVERGENTE_DOCUMENTO: 60,
    DATA_ASSINATURA_DIGITAL_FUTURA: 55,
    DATA_ASSINATURA_APOS_VENCIMENTO: 70,
});
