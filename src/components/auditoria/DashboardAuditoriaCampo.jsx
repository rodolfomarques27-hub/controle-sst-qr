...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
        ...
        .titulo-pdf-padrao h2 { margin: 0; color: #075a9c; font-size: 13.8px; line-height: 1.16; text-transform: uppercase; letter-spacing: .045em; font-weight: 900; white-space: normal; max-width: 98%; }
