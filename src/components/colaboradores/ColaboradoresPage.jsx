                    ...
                    <div className="mb-4 flex flex-col gap-3 lg:flex-row">
                        ...
                        <div className="relative min-w-56">
                            ...
                            <select
                                ...
                                name="colaboradores-filtro-empresa"
                        ...
                        <div className="relative min-w-56">
                            ...
                            <select
                                ...
                                name="colaboradores-filtro-funcao"
                                value={filtroFuncao}
                                onChange={(e) =>
                                    setFiltroFuncao(
                                        e.target.value
                        ...
                        <div className="relative min-w-56">
                            ...
                            <select
                                id="colaboradores-filtro-status"
                                name="colaboradores-filtro-status"
