            ...
            <div className="flex w-full items-stretch gap-2">
                ...
                <div className="relative w-[155px] shrink-0">
                    <select
                        ...
                        className="novo-colaborador-input-anterior h-full w-full cursor-pointer appearance-none px-3 pr-8 text-center text-xs font-bold text-slate-950"
                    >
...
export function FormularioNovoColaborador({
    ...
    return (
        <div className="novo-colaborador-layout-anterior">
            ...
            <div className="grid gap-3 lg:grid-cols-[0.82fr_1.18fr_1fr]">
                <CampoSelect
