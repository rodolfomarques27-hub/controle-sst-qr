          ...
          {diagnosticoComparativoAncoraNumerica ? (
            <div className="px-4 pb-4">
              <div className="rounded-xl border border-slate-200 bg-slate-50 p-3">
                ...
                {Array.isArray(diagnosticoComparativoAncoraNumerica?.amostraSomentePrincipal) && diagnosticoComparativoAncoraNumerica.amostraSomentePrincipal.length ? (
                  <div className="mt-3 overflow-x-auto rounded-lg border border-slate-200 bg-white">
                    <div className="border-b border-slate-200 bg-slate-50 px-3 py-2">
                      <p className="text-xs uppercase tracking-wide text-slate-500">Amostra: somente na principal</p>
                    </div>
                    ...
                    <table className="min-w-full divide-y divide-slate-200 text-left text-xs">
                      ...
                      <tbody className="divide-y divide-slate-100 bg-white">
                        {diagnosticoComparativoAncoraNumerica.amostraSomentePrincipal.map((item, indice) => (
                          <tr key={`${item?.numero || "n"}-${item?.nome || "nome"}-${indice}`}>
                            <td className="px-3 py-2 text-slate-700">{item?.numero || "-"}</td>
                            <td className="px-3 py-2 text-slate-700">
                              <div className="max-w-[18rem] break-words">{item?.nome || "-"}</div>
