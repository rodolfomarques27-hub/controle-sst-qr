...
export const EVENTOS_AUDITORIA_SISTEMA_PADRAO = [
    ...
    criarEventoAuditoriaSistema({ chave: "CONFIGURACOES_DESBLOQUEADAS", label: "Configurações desbloqueadas", categoria: "Configurações", modulo: "Configurações", nivel: "seguranca", descricao: "Registra desbloqueio operacional da aba Configurações." }),
    criarEventoAuditoriaSistema({ chave: "CONFIGURACOES_BLOQUEADAS", label: "Configurações bloqueadas", categoria: "Configurações", modulo: "Configurações", nivel: "seguranca", descricao: "Registra bloqueio manual da aba Configurações." }),
    criarEventoAuditoriaSistema({ chave: "CONFIGURACAO_EVENTOS_AUDITORIA_ALTERADA", label: "Eventos da Auditoria do Sistema alterados", categoria: "Configurações", modulo: "Configurações", nivel: "seguranca", descricao: "Registra alteração, restauração ou habilitação em massa dos eventos auditáveis." }),
